...
│   │   ├── color_palette.png       # Bảng màu chủ đạo 
│   │   ├── logo_company.png        # Logo của Superstore
│   │   └── background_layout.png   # Ảnh nền Dashboard 
...
│
│
├── .gitignore                      # File ẩn để git bỏ qua thư mục rác
├── README.md                       # Hướng dẫn đọc dự án (Rất quan trọng)
